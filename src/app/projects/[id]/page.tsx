      ...
      <main className="pt-20">
        ...
        <section className="relative overflow-hidden py-20 md:py-28">
          ...
          <div className="relative mx-auto max-w-5xl px-6 md:px-10">
            ...
            <h1 className="mt-6 font-display text-2xl font-black tracking-tight sm:text-4xl md:text-[100px]">
              <span style={{ color: project.color }}>{project.title}</span>
            </h1>

            <p className="mt-3 font-display text-base text-secondary sm:text-lg md:text-[25px]">
              {project.tagline}
            </p>
